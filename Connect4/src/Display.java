...
public class Display {
    ...
    public String getMessage(Status status) {
        switch (status) {
            case PLAYER1_PLAYS : return "Juga el jugador VERMELL";
            case PLAYER2_PLAYS : return "Juga el jugador GROC";
            case PLAYER1_WINS  : return "Ha guanyat el jugador VERMELL";
            case PLAYER2_WINS  : return "Ha guanyat el jugador GROC";
    ...
    private Color colorFromStatus(Status status) {
        return status == Status.PLAYER1_PLAYS ? PLAYER1 : PLAYER2;
    }
